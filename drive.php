...
<div class="well" >
  <h2>
      Driving From and To? <br><br>
    </h2>
    <div class="container-fluid">
  <div class="row-fluid">
    <div class="span6">

      <form class="form-horizontal" action="driveAction.php" method="POST" >
    ...
    <div class="span6">
      <div class="form-horizontal">
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <input  type="text"  id="seats" name="seats" onchange=""/>
          </div>
        </div>
         ...
         <div class="control-group">
          ...
          <div class="controls">
            <input  type="text"  id="distance" name="ride_distance" onchange=""/>
          </div>
        </div>
